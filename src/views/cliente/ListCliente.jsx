                          ...
                          <List>
                            {cliente.enderecos.map((endereco, index) => (
                              <List.Item key={endereco.id}>
                                Endereço {index + 1}
                                <List>
                                  <List.Item>{endereco.rua}</List.Item>
                                  <List.Item>{endereco.numero}</List.Item>
                                  <List.Item>{endereco.bairro}</List.Item>
                                  <List.Item>{endereco.cidade}</List.Item>
                                  <List.Item>{endereco.cep}</List.Item>
                                  <List.Item>{endereco.estado}</List.Item>
                                  <List.Item>{endereco.complemento}</List.Item>
                                </List>
                              </List.Item>
                            ))}
                          </List>
